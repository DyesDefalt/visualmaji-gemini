        ...
        <header className="sticky top-0 z-40 bg-stone-950/80 backdrop-blur-xl border-b border-stone-800 px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="lg:hidden flex items-center gap-3">
              <Link to="/" className="w-10 h-10 bg-gradient-to-br from-amber-500 to-amber-700 rounded-xl flex items-center justify-center">
                <Zap size={20} />
              </Link>
            </div>
              ...
              <AnimatePresence>
                {isDropdownOpen && (
                  ...
                  >
                    ...
                    <div className="p-2">
                      <Link to="/pricing" className="block px-3 py-2 rounded-lg hover:bg-stone-800 transition-colors">
                        Upgrade Plan
                      </Link>
                      <button 
                        onClick={handleLogout}
