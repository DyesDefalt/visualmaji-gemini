...
export const MagneticButton = ({ children, className, onClick, setCursorVariant, href, ...props }) => {
  ...
  return (
    <footer className="bg-stone-950 text-white px-6 py-20 md:px-12 relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end border-t border-white/10 pt-12 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-12 text-sm text-stone-400">
          <div>
            <h5 className="text-white font-bold mb-4">Product</h5>
            <Link href="/" className="block hover:text-white transition-colors">Visual Maji Web</Link>
